package ait.cohor63.shop.security.filter;

import ait.cohor63.shop.security.AuthInfo;
...
public class TokenFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (accessToken != null && tokenService.validateAccessToken(accessToken)) {
            ...
            // Конвертируем Claim -> AuthInfo (чтобы Security смог работать с этим объектом)
    ...
    private String getTokenFromRequest(HttpServletRequest httpServletRequest) {
        ...
        // Если заголовок пустой или не начинается с "Bearer "
        return  null;
    }
}
